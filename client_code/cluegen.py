# Source: https://github.com/anvilistas/anvil-labs/blob/main/client_code/cluegen.py
# SPDX-License-Identifier: MIT
# Copyright (c) 2021 anvilistas
#
# Original code: https://github.com/dabeaz/cluegen
# Author: David Beazley (@dabeaz). http://www.dabeaz.com


MemberDescriptorType = type(range.start)

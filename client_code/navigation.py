...
def go_dash(top_form):
  top_form.title_label.text = "Dashboard"
  top_form.test_link.visible = True 
  top_form.settings_button.visible = True
  top_form.home_button.visible = True
  top_form.home_button.role = "primary-color"
  top_form.settings_button.role = "raised"
...
def go_settings(top_form):
  top_form.title_label.text = "Settings"
  top_form.test_link.visible = True
  top_form.settings_button.visible = True
  top_form.home_button.visible = True
  top_form.home_button.role = "raised"
  top_form.settings_button.role = "primary-color"
